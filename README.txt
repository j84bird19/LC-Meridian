...
LC14 patch:
- Supplies subtabs cleaned up to Supplies List and Product Inventory.
- Item tab removed from visible tabs; item sheets open inside Supplies List flow.
- Receipts moved behind Supplies List → Receipts button.
- Receipt folder foundation added.
- Product Inventory foundation added for finished sellable products.
- Studio/Mockup Builder/Scratch Pad untouched in this patch.
- Do not upload app-v49_15.backup.js.
